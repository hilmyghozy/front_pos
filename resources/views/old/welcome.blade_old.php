                            ...
                            <div class="card-body" id="jenis-ticket1">
                                @foreach ($item as $produk)
                                    @if ($produk->id_kategori == $kategori['id_kategori'])
                                        <button type="button" class="btn-style btn-produk datatiket" id="tiket-id-{{$produk->id_item}}" data-dataid="{{$produk->id_item}}" value="{{$produk->nama_item}}">{{$produk->nama_item}}<br>Rp. {{number_format($produk->harga_jual,0,',','.')}}</button>
                                    @endif
                                @endforeach
                            </div>
                        </div>
